  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className={`flex items-center gap-3 px-4 py-5 border-b border-dark-700/60 ${collapsed ? 'justify-center' : ''}`}>
        <img src="/logo.png" alt="SKM Logo" className="w-10 h-10 object-contain flex-shrink-0 drop-shadow-lg" />
        {!collapsed && (
          <div>
            <p className="font-bold text-white text-sm leading-tight uppercase tracking-wider">SKM Servicio</p>
            <p className="text-[10px] text-brand-400 font-medium tracking-[0.2em] uppercase">Técnico</p>
          </div>
        )}
      </div>
