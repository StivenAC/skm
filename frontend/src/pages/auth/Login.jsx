      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-to-br from-dark-800 via-dark-900 to-dark-800 p-12 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-4">
            <img src="/logo.png" alt="SKM Logo" className="w-16 h-16 object-contain drop-shadow-2xl" />
            <div>
              <p className="text-2xl font-bold text-white tracking-tight uppercase">SKM Servicio</p>
              <p className="text-brand-400 text-sm font-semibold tracking-[0.3em] uppercase">Técnico</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative text-dark-500 text-xs">
          © 2026 SKM Servicio Técnico. Sistema de Gestión v1.0
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <img src="/logo.png" alt="SKM Logo" className="w-12 h-12 object-contain" />
            <div>
              <p className="font-bold text-white uppercase">SKM Servicio Técnico</p>
              <p className="text-brand-400 text-[10px] uppercase tracking-widest font-bold">Sistema de Gestión</p>
            </div>
          </div>
