...
async function main() {
  ...
  const basicPrepTemplate = await prisma.checklistTemplate.upsert({
    where: { id: 'tpl-basic-preparation' },
    update: {},
    create: {
      id: 'tpl-basic-preparation',
      name: 'Alistamiento Básico',
      motorcycleType: 'Motocross',
      description: 'Checklist básico de recepción: aceite, frenos, llantas y lubricaciones.',
      templateItems: {
        create: [
          { category: 'Motor', label: 'Nivel de aceite motor', isRequired: true, order: 1 },
          { category: 'Motor', label: 'Niveles de líquidos (frenos, refrigerante, hidráulico)', isRequired: true, order: 2 },
          { category: 'Frenos', label: 'Revisión de pastillas y discos', isRequired: true, order: 3 },
          { category: 'Frenos', label: 'Estado y ajuste de cables/bombas', isRequired: false, order: 4 },
          { category: 'Llantas', label: 'Presión y desgaste de llantas', isRequired: true, order: 5 },
          { category: 'Llantas', label: 'Estado de válvulas y cámaras', isRequired: false, order: 6 },
          { category: 'Transmisión', label: 'Tensión de cadena / correa', isRequired: true, order: 7 },
          { category: 'Lubricación', label: 'Engrase de puntos de pivote y palancas', isRequired: true, order: 8 },
          { category: 'Eléctrico', label: 'Funcionalidad de luces y batería', isRequired: false, order: 9 },
          { category: 'General', label: 'Inspección visual general de chasis y plásticos', isRequired: false, order: 10 },
        ],
      },
    },
  });
